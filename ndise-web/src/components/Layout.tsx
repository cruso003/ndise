    ...
    agency: [
      {
        ...
        items: [
          { icon: LayoutDashboard, label: 'API Dashboard', to: '/agency/dashboard', permissions: ['agency:read'] },
          { icon: FileCheck, label: 'Verification', to: '/agency/verification', permissions: ['agency:write'] },
          { icon: Package, label: 'Batch Verification', to: '/agency/batch', permissions: ['agency:write'] },
          { icon: Key, label: 'API Keys', to: '/agency/api-keys', permissions: ['agency:read'] },
          { icon: BookOpen, label: 'Documentation', to: '/agency/documentation', permissions: ['agency:read'] },
